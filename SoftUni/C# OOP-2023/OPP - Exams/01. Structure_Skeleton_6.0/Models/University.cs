...
namespace UniversityCompetition.Models
{
    public class University : IUniversity
    {
        ...
        private ICollection<int> requiredSubgects;
        ...
        public University(int universityId, string universityName, string category, int capacity, ICollection<int> requiredSubjects)
        {
            ...
            Category = category;
            Capacity = capacity;
            requiredSubgects = requiredSubjects;
        }
        ...
        public IReadOnlyCollection<int> RequiredSubjects => requiredSubgects.ToList().AsReadOnly();
    }
}
