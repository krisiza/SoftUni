...
namespace GameZone.Migrations
{
    ...
    [Migration("20240930100937_seededData")]
            ...
            modelBuilder.Entity("GameZone.Data.Models.Game", b =>
                {
                    ...
                    b.Property<int>("GenreId")
                        .HasColumnType("int")
                        .HasComment("Game genre id");

                    b.Property<string>("ImageUrl")
                        .HasColumnType("nvarchar(max)")
                        .HasComment("Game image url");

                    b.Property<string>("PublischerId")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)")
                        .HasComment("Game Publisher id");

                    b.Property<DateTime>("ReleasedOn")
                        .HasColumnType("datetime2")
                        .HasComment("Game released date");
                    ...
                    b.HasIndex("PublischerId");

                    b.ToTable("Games");

                    b.HasComment("All games");
                });
            ...
            modelBuilder.Entity("GameZone.Data.Models.Game", b =>
                {
                    ...
                    b.HasOne("Microsoft.AspNetCore.Identity.IdentityUser", "Publischer")
                        .WithMany()
                        .HasForeignKey("PublischerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Genre");

                    b.Navigation("Publischer");
                });
